            ...
            <form id="form" method="post">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" name="network_topology"placeholder="Network Topology" require>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-check-input" type="radio" name="type_network" id="flexRadioDefault1" value="10/100 Mbps" require>10/100 Mbps
                        <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="cabling_structure" value="Yes" id="flexRadioDefault1" require>YES
                            <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="isolated_network" value="Yes" id="flexRadioDefault1" require>YES
                            <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text " class="form-control" id="inputEmail4" name="proxy_config" placeholder="Proxy Configured " require>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="power_backup" value="Yes"id="flexRadioDefault1" require>YES
                            <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" name="type_structured_network"
                         placeholder="eg. CAT 5/6..." require>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="LAN" value="Single" id="flexRadioDefault1" require>Single<br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input type="radio"  class="form-check-input" id="inputEmail4" value="Domain" name="clg_network" require>Domain
                            <br>
