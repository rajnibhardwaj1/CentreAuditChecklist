<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
	{
        ...
        if(!empty($b_connection_type) && !empty($b_service_provider) && !empty($b_internet_bandwidth) && !empty($b_for_IBT))
        {   //save to database
			//$user_id = random_num(20);
			$query = "insert into backup_internet(b_connection_type,b_service_provider,b_internet_bandwidth,b_for_IBT) 
            values ('$b_connection_type','$b_service_provider','$b_internet_bandwidth','$b_for_IBT')";
		...
		{
			echo "<script> alert('Please enter the details required');window.location='Backup_internet.php'</script>";
		}
    }
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h2 id="heading">Backup Internet</h2><hr>
            ...
            <form id="form" method="post">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-check-input" type="radio" name="b_connection_type" value="Broadband"id="flexRadioDefault1" require>Broadband
                        <br>
                        <input class="form-check-input" type="radio" name="b_connection_type" value="Lease Line" id="flexRadioDefault1"require>Lease Line
                        </div>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" name="b_service_provider" require placeholder="Service Providers ">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="inputEmail4" name="b_internet_bandwidth" placeholder="in MBPS" require>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" value="Yes"name="b_for_IBT" id="flexRadioDefault1" require>YES
                            <br>
                            <input class="form-check-input" type="radio" value="No"name="b_for_IBT" id="flexRadioDefault1" require>NO
                        </div>
                    </div>
