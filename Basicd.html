<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
	{
        ...
        {   //save to database
            ...
            waiting_space,queuing_space,screening_facility,regis_desk,server_room) 
...
<body onload="checkbos()">
            ...
            <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" id="inputFloor"
                            placeholder="Total number of labs" name="computer_labs">
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <input type="varchar" class="form-control" id="inputFloor"
                            placeholder="floors" name="floors">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-check-input" type="radio" name="PH_friendly" id="exampleRadios1" value="Yes">YES <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-8" style="text-align:justify;">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="lift_availability" id="exampleRadios1" value="Yes"/>YES <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-8" style="text-align:justify;">
                        ...
                        <div class="form-check">
                        <input class="form-check-input" type="radio" name="waiting_space" id="exampleRadios1" value="Yes">YES<br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-8"  style="text-align:justify;">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="queuing_space" id="exampleRadios1" value="Yes">YES<br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-8"  style="text-align:justify;">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="screening_facility" id="exampleRadios1" value="Yes">Yes<br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="	regis_desk" id="exampleRadios1" value="Yes">YES<br>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="server_room" id="exampleRadios1" value="Yes">YES<br>
                            <input class="form-check-input" type="radio" name="server_room" id="exampleRadios1" value="No">NO
                               
                        </div>
                    </div> 
                </div> 
                <label for="wifibuilding">Operating system on desktops</label>
                <select id="wifibuilding" name="wifibuilding" onchange="checkos();">
                    <option value="Select" selected>Same Building</option>
                    <!-- <option value="WindowsOS">Same Building</option> -->
                    <option value="diffrentB">Diffrent Building</option>
                </select><br>
                <!-- <div id=Win-version>
                ...
                <div id=Linux-version>
                    <label for="subnetmask">They are using same subnetmask</label>
                ...
                <label for="hotspot">Does TC belong to covid 19 hotstop areas?</label>
                <select id="hotspot" name="hotspot" onchange="hotspot();">
                    <option value="Select" selected>no</option>
                    <!-- <option value="WindowsOS">Same Building</option> -->
                    <option value="yes">yes</option>
                </select><br>
                <div id=TCSenitized>
                    <label for="TCSenitized">They are using same subnetmask</label>

                    <select name="TCSenitized">
                        <option value="yes">yes</option>
                        <option value="no">no</option>
                        <!-- <option value="centos">CentOS</option>
                        <option value="fedora">Fedora</option> -->
    ...
    <script>
        function checkos(){
            var ostype=document.getElementById("wifibuilding").value;
            if (ostype==="Select") {
        ...
        function hotspot(){
            var hots=document.getElementById("hotspot").value;
            if (hots==="Select") {
