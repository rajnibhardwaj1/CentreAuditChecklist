            ...
            <form id="form" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" name="b_service_provider" placeholder="Service Providers ">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" value="Yes"name="b_for_IBT" id="flexRadioDefault1">YES
                            <br>
                            <input class="form-check-input" type="radio" value="No"name="b_for_IBT" id="flexRadioDefault1">NO
                        </div>
                    </div>
