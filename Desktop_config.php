            ...
            <form id="form" method="post">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" placeholder="Min Hardisk Space" name="disk_space">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="License" placeholder="License OS in all Client node" name="os_license">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Name of Antivirus installed on PC's</label>
                        
                        <input type="text" class="form-control" id="Antivirus" name="antivirus_name" placeholder="Name of Antivirus installed on PC's">
                    </div>
                </div>
                 <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="Branded_machine" value ="Yes"id="flexRadioDefault1">YES
                            <br>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio"  id="ramework" value="Yes" name="dotnet_install">YES
                            <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio"  id="client" value="Yes"name="thin_client">YES
                            <br>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" id="count" value="yes"name="distance_norms"> YES
                            <br>
