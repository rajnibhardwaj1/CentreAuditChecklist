            ...
            <form id="form" method="post">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="UPS_availability" value="Yes"id="flexRadioDefault1">YES
                            <br>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                        <input class="form-check-input" type="radio" name="typeof_UPS" value="Individual" id="flexRadioDefault1">Individual
                            <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="inputEmail4" placeholder="In KVA" name="UPS_capacity">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="labsconnected_UPS" value="Yes"id="flexRadioDefault1">YES
                            <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="inputEmail4" name="UPS_backup_time" placeholder="In minutes">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" value="Yes" name="avail_diesel_genset" id="flexRadioDefault1">YES
                            <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="inputEmail4" name="genset_capacity" placeholder="in KVA">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                        <input class="form-check-input" type="radio" name="labsconnected_genset" value="Yes" id="flexRadioDefault1">YES
                        <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                        <input class="form-check-input" type="radio" name="switchover" value="Manual" id="flexRadioDefault1">Manual
                        <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="avail_backup_dg" value="Yes" id="flexRadioDefault1">YES
                            <br>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="inputEmail4" name="dg_capacity" placeholder="(in KVA)">
                    </div>
