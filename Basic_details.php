    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <p>Forms</p>
                <li class="active">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Basic_details</a>
                ...
                <li>
                    <a href="./Desktop_config.php">Desktop_config</a>
                ...
                <li>
                    <a href="./Power_backup.php">Power_backup</a>
                </li>
                <li>
                    <a href="#">Contact</a>
                </li>
